        ...
        private void openInterface() throws IOException {
            ...
            if(mControlInterface == null) {
                //throw new IOException("no control interface.");
                 ...
                 runCommand(cmd1);
                 String cmd2 = "su -c chmod 677 /sys/bus/usb/drivers/usb/unbind";
                 runCommand(cmd2);
                 String cmd3 = "echo -n usb1 > /sys/bus/usb/drivers/usb/unbind";
                 runCommand(cmd3);
                 String cmd4 = "su -c chmod 677 /sys/bus/usb/drivers/usb/bind";
                 runCommand(cmd4);
                 String cmd5 = "echo -n usb1 > /sys/bus/usb/drivers/usb/bind";
                 runCommand(cmd5);
                throw new IOException("no control interface");
            }
            Log.d(TAG, "Control iface=" + mControlInterface);
